...
public class SingleGame_Math extends Application implements SnakeGame {
    /*
    ...
    public void draw(GraphicsContext gc) { // Draw all the game screens
        ...
        if (letterIndex == 0){
            gc.fillText("[ " + question + " = ? ]", width / 2 - 50, unitSize, 200); // The word that appears in the center of the topBar
        } else if (letterIndex > 0) {
            gc.fillText("[ " + question + " = " + snake.getLetters()[snake.getLength()-1] + "? ]", width / 2 - 50, unitSize, 200); // The word that appears in the center of the topBar
        }
        ...
        for (int i = 1; i < snake.getLength(); i++) { //Drsaw the snake body by for loop
            gc.drawImage(new Image(new File("src" + File.separatorChar + "main" + File.separatorChar + "resources" + File.separatorChar +
                            "com" + File.separator + "edusnake" + File.separator + "image" + File.separatorChar + "body" + snake.getLetters()[i] + ".png").toURI().toString()),
        ...
        for (Food food : foods) {
            gc.drawImage(new Image(new File("src" + File.separatorChar + "main" + File.separatorChar + "resources" + File.separatorChar +
                            "com" + File.separator + "edusnake" + File.separator + "image" + File.separatorChar + "food" + food.getLetter() + ".png").toURI().toString()),
    ...
    public void initFood() {
        ...
        for (int i = 0; i < foods.length; i++) {
            ...
            if (i == 0) {
                foods[i].setLetter(String.valueOf(letter));
            } else {
                foods[i].setLetter(String.valueOf(new Random().nextInt(9)));
    ...
    public void newOperation(int operator) {
        switch (operator) {
            case 0 -> {
                int number1 = new Random().nextInt(20);
                int number2 = new Random().nextInt(20);
                firstNumber = Math.max(number1, number2);
                secondNumber = Math.min(number1, number2);
                thirdNumber = firstNumber - secondNumber;
                question = firstNumber + " - " + secondNumber;
            }
            case 1 -> {
                firstNumber = new Random().nextInt(20);
                secondNumber = new Random().nextInt(20);
                thirdNumber = firstNumber + secondNumber;
                question = firstNumber + " + " + secondNumber;
            }
            case 2 -> {
                firstNumber = new Random().nextInt(10);
                secondNumber = new Random().nextInt(10);
                thirdNumber = firstNumber * secondNumber;
                question = firstNumber + " × " + secondNumber;
            }
            case 3 -> {
        ...
        word = String.valueOf(thirdNumber);
        letter = String.valueOf(word.toCharArray()[letterIndex]);
    }
